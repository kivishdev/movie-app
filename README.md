...
How we met the specific technical requirements:
...
Sort by Rating, Duration, Year, or Name.

Calendar Filter: Filter movies specifically by release year.
...
Admin Dashboard:
CRUD Operations: Manually Add, Edit, or Delete movies.
Force Sync: A dedicated button to force-trigger the scraper and refresh the database.
